...
/**
 * SequenceRunner provides an algorithm for running a StochasticGrammar. GroundTokens generated by the grammar are
 * stored in a flattened sequence, and the act() methods are applied starting with a blank instance, and applying each
 * token in order of the generated sequence.
 *
